    ...
    <main className="mx-auto max-w-[320px] sm:max-w-[640px] md:max-w-[768px] lg:max-w-[1024px] xl:max-w-[1240px]">
      ...
      <div className="mx-10 max-w-[580px]">
        <p className="flex min-h-screen  justify-center">
          Hello! <br></br> I&apos;m Sofia Kotova, a Frontend Developer. My name
          is Sofia, and I&apos;m a frontend developer! 👩‍💻 <br></br>I possess
          strong soft skills, diverse experience, and creative thinking, which
          helps me find unique solutions. <br></br>
          After changing careers, I&apos;ve learned a lot about working with
          teams in stressful situations and know how to organize myself and
          others to achieve the best results without burnout. I have a solid
